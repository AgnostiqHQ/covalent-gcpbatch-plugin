...
(() => {
const core = __nccwpck_require__(335);
const github = __nccwpck_require__(191);
const fs = __nccwpck_require__(147);
const semverUtils = __nccwpck_require__(288);
  ...
  octokit.rest.repos
    ...
    .then((compareCommits) => {
      ...
      rl.on("close", () => {
        ...
        const version = useRcSuffix ? `${simplifiedSemver}-rc.0` : simplifiedSemver;
